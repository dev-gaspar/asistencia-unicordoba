  ...
  res.json({ 
    ...
    endpoints: {
      ...
      'Eventos': {
        ...
        'GET /api/eventos/dispositivo/:codigo': 'Evento activo por dispositivo (autenticado)',
        'PUT /api/eventos/:id': 'Actualizar evento (autenticado)',
        'DELETE /api/eventos/:id': 'Eliminar evento (autenticado)'
      },
      'Asistencia': {
        'POST /api/asistencia/registrar': 'Registrar asistencia desde ESP32 (público)',
        'GET /api/asistencia/evento/:eventoId': 'Asistencias de un evento (autenticado)',
        'GET /api/asistencia/evento/:eventoId/estadisticas': 'Estadísticas de evento (autenticado)',
        'GET /api/asistencia/estudiante/:estudianteId': 'Historial de estudiante (autenticado)',
